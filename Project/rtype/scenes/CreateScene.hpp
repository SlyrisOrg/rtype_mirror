...
namespace rtype
{
    ...
    private:
        ...
        using CreateFactionT = CW::EnumType;
        using WidgetT = CW::EnumType;
    ...
    private:
        ...
        CreateFactionT __selectedFaction{CW::Bheet};
        CreateFactionT __oldSelectedFaction{CW::Bheet};
        std::unordered_map<CreateFactionT, std::tuple<PV, Attack, Defense, Support>> _stats
            {
                {CW::Bheet, std::make_tuple(PV{1000, 10000, CW::PV},
                                            Attack{200, 1000, CW::Attack},
                                            Defense{70, 1000, CW::Defense},
                                            Support{20, 1000, CW::Support})},
                {CW::Kooy,  std::make_tuple(PV{1550, 10000, CW::PV},
                                            Attack{80, 1000, CW::Attack},
                                            Defense{120, 1000, CW::Defense},
                                            Support{150, 1000, CW::Support})},
                {CW::Maul,  std::make_tuple(PV{2100, 10000, CW::PV},
                                            Attack{20, 1000, CW::Attack},
                                            Defense{180, 1000, CW::Defense},
                                            Support{80, 1000, CW::Support})}
            };
