...
namespace rtype
{
    ...
    private:
        ...
        void __disableToggleButton(ToggleButton &toDisable, Args&& ...otherLangs) noexcept
        {
            toDisable.setSelected(false);
            __disableToggleButton(std::forward<Args>(otherLangs)...);
        }

        template <typename ...Args>
        void __internalDisableToggleButton(CEGUI::ToggleButton &langSelected, Args&& ...otherLangs) noexcept
        {
