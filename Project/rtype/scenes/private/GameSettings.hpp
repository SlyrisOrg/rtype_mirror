...
namespace rtype
{
    ...
    {
    public:
        GameSettings(BaseGUI <cfg::profil::nbWidgets> &gui, gutils::EventManager &evtMgr) noexcept :
            _gui(gui), _evtMgr(evtMgr)
        {
        }
    ...
    private:
        ...
        void __miscLang() noexcept
        {
            ...
            _gui[ProfilWidgets::RightPanelLangSettings].setName(
                _gui[ProfilWidgets::RightPanelLangSettings].getName() + "Active");
        }
        ...
        void __miscSound() noexcept
        {
            ...
            static_cast<CEGUI::Slider &>(_gui[ProfilWidgets::SoundsEffectSlider]).setCurrentValue(
                cfg::game::soundseffectVolume);
        ...
        void __subscribeEvents() noexcept
        {
            ...
            _gui[ProfilWidgets::ApplyButton].subscribeEvent(pb::EventClicked,
                                                            evt::Subscriber(&gs::__applyChange, this));
            ...
            _gui[ProfilWidgets::TabButtonSounds].subscribeEvent(tg::EventMouseClick,
                                                                evt::Subscriber(&gs::__soundsTabButtonStateChange,
                                                                                this));
            ...
            _gui[ProfilWidgets::SoundsEffectCheckBox].subscribeEvent(tg::EventSelectStateChanged,
                                                                     evt::Subscriber(&gs::__soundsEffectCheckBoxChange,
                                                                                     this));
        }
