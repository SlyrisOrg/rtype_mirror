...
namespace rtype
{
    ...
    public:
        ...
        static void setTextCB(std::pair<CEGUI::Window *, std::string> &&tp) noexcept;
        static void setSizeCB(std::pair<CEGUI::Window *, CEGUI::USize> &&tp) noexcept;
        static void setPropertyCB(std::tuple<CEGUI::Window *, std::string, std::string> &&tp) noexcept;
