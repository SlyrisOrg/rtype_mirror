...
namespace rtype
{
    ...
    public:
        struct Item
        {
            Item(sf::Vector2f size, sf::Vector2f position, const Object *obj) : objPtr(obj)
            {
                rect.setSize(size);
    ...
    public:
        ...
        // querry : retrieve obj that can potentially
        // collide with your current obj by getting said object
        // by the quadtree pointer held by the cur obj
        // when parcouring objects to check collision
