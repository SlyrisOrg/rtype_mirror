...
namespace rtype
{
    ...
    public:
        ...
        Action(const sf::Keyboard::Key &key, int type = Type::RealTime | Type::Pressed) noexcept : type(type)
        {
            event.type = sf::Event::EventType::KeyPressed;
            event.key.code = key;
        }

        Action(const sf::Mouse::Button &button, int type = Type::RealTime | Type::Pressed) noexcept : type(type)
        {
    ...
    class ActionMap : public utils::NonCopyable
    {
    public:
    ...
    template <typename T = int>
    class ActionTarget : public utils::NonCopyable
    {
    public:
        ...
        void unbind(const T &key) noexcept
        {
