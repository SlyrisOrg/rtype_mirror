...
namespace rtype
{
    ...
    pplx::task<void>
    API::requestLogin(std::string const &username, std::string const &password, bool &freshAccount,
    ...
    pplx::task<void> API::requestCreatePlayer(std::string const &pseudo, std::string const &tokens,
                                              std::error_code &ec) noexcept
    {
...
#endif
                log(lg::Info) << "Token Session -> " << utils::LightGreen << token << utils::Reset << std::endl;
