...
namespace rtype
{
    ...
    public:
        /**
         * @brief allows you to connect to the game through an account name and password
         *
        ...
        /**
         * @brief allow you to create a pilot with his own faction.
         *
        ...
        /**
         * @brief allow you to get the data information about a connected player.
         *
         * @param tokens The token, is the current JWT of the connected player.
         * @param ec An error_code that can contain the error message in case we couldn't get player data.
         *
         * @details The player data contains several information about his account :
         * level, gold, experience, faction, nickname, etc...
         */
