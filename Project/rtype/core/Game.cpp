...
namespace rtype
{
    ...
    Game::~Game() noexcept
    {
        _log(lg::Info) << "Shutting down each Systems of RType." << std::endl;
    }
    ...
    void Game::__initSystems()
    {
        ...
        _log(lg::Info) << "Successfully initializing all the Systems of RType\nRType will start soon ..." << std::endl;
    ...
    void Game::receive([[maybe_unused]] evt::GameShutdown const &evt) noexcept
    {
        _shutDown = true;
    }
