...
namespace rtype
{
    ...
    public:
        /**
         * @fn explicit SoundManager(gutils::EventManager &evtMgr) noexcept
    ...
    public:
        ...
        /**
         * @fn void receive(const evt::PlaySoundEffect &evt) noexcept
         * @brief
        ...
        /**
         * @fn void receive(const evt::StopMusic &evt) noexcept
         * @brief
        ...
        /**
         * @fn void receive(const evt::PlayMusic &evt) noexcept
         * @brief
