...
namespace gutils
{
     ...
     * @details all scenes should inherits from this interface
     */
    class AScene : public gutils::Receiver<AScene>
    {
    public:
        explicit AScene(gutils::EventManager &evtMgr, std::string sceneName, sf::RenderWindow &win) noexcept :
            _evtMgr{evtMgr},
        ...
        /**
         * @brief
         * used by the sceneManager when launching a scene,
