...
namespace gutils
{
    ...
    private:
        ...
        using ReceiversArray = std::vector<std::pair<BaseReceiver *, CbPtr>>;
        using ReceiversMap = std::unordered_map<EventTypeID, ReceiversArray>;
